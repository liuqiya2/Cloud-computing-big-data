...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://4if4bmoq31.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-filename', 'body', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-filename', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
    ...
    apigClient.folderItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['item', 'folder', 'Content-Type', 'x-amz-meta-customLabels', 'x-api-key'], ['body']);
